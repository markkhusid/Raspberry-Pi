...
# 2 "sizeofvariables.c" 2
# 1 "/usr/lib/gcc/aarch64-linux-gnu/7/include/stdbool.h" 1 3 4
# 3 "sizeofvariables.c" 2
...
# 10 "sizeofvariables.c" 3 4
_Bool 
# 10 "sizeofvariables.c"
     f = 
# 10 "sizeofvariables.c" 3 4
         1
# 10 "sizeofvariables.c"
 ...
 printf ("b val %4.2 & size %d bytes (@addr %p).\n", b, sizeof(b), &b);
 printf ("c val %d (oct %o, hex %x) &  size %d bytes (@addr %p).\n", c, c, c, sizeof(c), &c);
